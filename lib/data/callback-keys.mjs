...
//
// EXT-34 A LIVRAT, SI PARAGRAFUL DE MAI SUS NU MAI ESTE ADEVARAT DESPRE "NIMIC NU
// LE CITESTE": ruta le citeste si le stocheaza de la migratia 0053. Ele stau acum
// si in listele rutei, de mai jos, iar lista proprie ramane, cu aceleasi cinci,
// ca verificarea sa poata spune ca exact ele au fost mutate. Multimea cheilor
// cunoscute este aceeasi, deci niciun avertisment nu se schimba.
//
...
/** EXT-34: trimise deja de expeditor. Pana la 0053 citite de nimic si cunoscute
 *  numai ca sa nu avertizeze; de atunci citite de ruta si prezente si in
 *  listele de mai sus. */
